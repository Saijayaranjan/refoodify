        ...
        <div className="bg-gray-800/30 backdrop-blur-sm border border-gray-700/50 rounded-2xl p-8">
          ...
          <div className="mt-6">
            ...
            <button
              ...
              disabled={true}
              className="mt-4 w-full py-3 px-4 bg-gray-600 text-gray-400 font-medium rounded-lg cursor-not-allowed flex items-center justify-center space-x-2 opacity-50"
            >
